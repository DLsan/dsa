    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-200">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          />
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 text-transparent bg-clip-text">D L Sanjai</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-6">DSA Enthusiast & Software Engineer</p>
          <div className="flex justify-center space-x-4">
            <a href="https://github.com/DLsan" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/dl-sanjai?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="icon" className="rounded-full bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700 hover:border-purple-500">
                <FaLinkedin className="h-5 w-5" />
                <span className="sr-only">LinkedIn</span>
              </Button>
            </a>
            <a href="mailto:dlsanjai@gmail.com" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="icon" className="rounded-full bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700 hover:border-purple-500">
